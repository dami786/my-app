...
function hero1() {
 ...
 <div className='flex items-center justify-between'>
      ...
      <p className='font-bold text-2xl text-black mt-8 flex items-center'>Experiencing in Paris<span><ChevronRight size={20} /></span></p>
      </div>
      <div className='mt-8'>
...
const products3=[
  ...
  image:"e31.avif"
    },
    {
      ...
      Label:"popular",
      label2:<Heart className='fill-black/30'/>,
      tittle:"Discover paris hidden bars",
      Price:"90 for 2 Nights",
      Icon2:<Star size={9}/>,
      Rating:5,
      image:"e32.avif"
